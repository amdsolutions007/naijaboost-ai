"""Concrete SMM client implementation for the JasaSMM partner (secondary backup provider)."""
...
class JasaSMMClient(BaseSMMClient):
    """Client responsible for interacting with the JasaSMM SMM API v2 (Indonesian IDR / Rp panel)."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # JasaSMM authenticates via payload key parameter.
        return {}
