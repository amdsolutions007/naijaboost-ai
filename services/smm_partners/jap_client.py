"""Concrete SMM client implementation for the JustAnotherPanel (JAP) partner (seventh fulfillment provider)."""
...
class JustAnotherPanelClient(BaseSMMClient):
    """Client responsible for interacting with the JustAnotherPanel (JAP) SMM API v2."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # JustAnotherPanel authenticates via payload key parameter.
        return {}
