"""Concrete SMM client implementation for the MoreThanPanel (MTP) partner."""
...
class MoreThanPanelClient(BaseSMMClient):
    """Client responsible for interacting with the MoreThanPanel (MTP) SMM API v2."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # MoreThanPanel authenticates via payload key parameter.
        return {}
