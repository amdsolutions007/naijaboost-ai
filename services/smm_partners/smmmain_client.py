"""Concrete SMM client implementation for the SMMMain partner (fifth fulfillment provider)."""
...
class SMMMainClient(BaseSMMClient):
    """Client responsible for interacting with the SMMMain SMM API v2."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # SMMMain authenticates via payload key parameter.
        return {}
