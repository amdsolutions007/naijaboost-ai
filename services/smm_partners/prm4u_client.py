"""Concrete SMM client implementation for the PRM4U partner."""
...
class PRM4UClient(BaseSMMClient):
    """Client responsible for interacting with the PRM4U SMM API."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # PRM4U authenticates via payload key parameter.
        return {}
