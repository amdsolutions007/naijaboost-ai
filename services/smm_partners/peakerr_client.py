"""Concrete SMM client implementation for the Peakerr partner (eleventh fulfillment provider)."""
...
class PeakerrClient(BaseSMMClient):
    """Client responsible for interacting with the Peakerr SMM API v2."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # Peakerr authenticates via payload key parameter.
        return {}
