"""Concrete SMM client implementation for the NiceSMMPanel partner (ninth fulfillment provider)."""
...
class NiceSMMPanelClient(BaseSMMClient):
    """Client responsible for interacting with the NiceSMMPanel SMM API v2."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # NiceSMMPanel authenticates via payload key parameter.
        return {}
