"""Concrete SMM client implementation for the Instant-Fans partner (eighth fulfillment provider)."""
...
class InstantFansClient(BaseSMMClient):
    """Client responsible for interacting with the Instant-Fans SMM API v2."""
    ...
    def build_auth_headers(cls, api_key: str) -> dict[str, str]:
        # Instant-Fans authenticates via payload key parameter.
        return {}
